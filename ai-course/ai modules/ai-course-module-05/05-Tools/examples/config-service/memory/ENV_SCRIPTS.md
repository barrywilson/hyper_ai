...
### Ports
- **API Service**: http://localhost:8000 (configurable via `PORT` env var, defaults to 8000)
- **UI Development**: http://localhost:3000 (Vite dev server)
- **Database**: localhost:5433 (docker-compose published port; container's internal port is 5432)
