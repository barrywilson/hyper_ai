...
The `feature_flags` schema (key + nested `enabled` boolean) matches the active work item under `docs/001-feature-flags.md` and its plan documents under `docs/plans/`.
