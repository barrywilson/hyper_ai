...
Define how feature flags should be introduced into the Configuration Service so module 3's active workflow story reflects a realistic next feature without removing the existing observability scaffolding.
